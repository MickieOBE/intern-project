...
function HomeAbout() {
  ...
  return (
    <div
      className="flex items-center justify-center h-[100vh]  border-t-2 mt-8 "
      style={{
        backgroundImage:
          'url("https://res.cloudinary.com/dmhsf5hqd/image/upload/v1689868245/pexels-albin-berlin-906982_sypvqu.jpg")',
    ...
    >
      <div className="w-full h-full flex items-center justify-between bg-gray-900/70 ">
        ...
        <img
          src="https://res.cloudinary.com/dmhsf5hqd/image/upload/v1689869287/pexels-ketut-subiyanto-4473405-removebg-preview_hf29m0.png"
          alt=""
